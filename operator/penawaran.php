...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="../operator/dashboard.php" class="brand-link">
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="penawaran.php" class="nav-link">
                                <i class="nav-icon fa-light fa-hammer"></i>
                                <p>
                                    Penawaran
                                </p>
                            </a>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Nama Barang</th>
                                    <th>Deskripsi</th>
                                    <th>Penawaran Tertinggi</th> <!-- Menampilkan penawaran tertinggi -->
                                    <th>Foto</th>
                                    <th>Status</th>
                                    <th>Actions</th>
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT barang.id_barang, barang.nama_barang, barang.deskripsi, barang.foto, barang.status, MAX(lelang.penawaran_tertinggi) AS penawaran_tertinggi
        FROM barang
        LEFT JOIN lelang ON barang.id_barang = lelang.id_barang
        GROUP BY barang.id_barang";
                   ...
                   <td>
                       <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#editModal' 
                           ...
                           data-harga='{$row['penawaran_tertinggi']}' data-status='{$row['status']}'>
                           Edit
                       </button>
                   </td>
               </tr>";
